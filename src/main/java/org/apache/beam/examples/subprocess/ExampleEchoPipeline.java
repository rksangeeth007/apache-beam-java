 ...
 */
package beam.examples.subprocess;

import java.util.ArrayList;
import java.util.List;
import beam.examples.subprocess.configuration.SubProcessConfiguration;
import beam.examples.subprocess.kernel.SubProcessCommandLineArgs;
import beam.examples.subprocess.kernel.SubProcessCommandLineArgs.Command;
import beam.examples.subprocess.kernel.SubProcessKernel;
import beam.examples.subprocess.utils.CallingSubProcessUtils;
